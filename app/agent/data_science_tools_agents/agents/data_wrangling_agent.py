...
class DataWranglingAgent(BaseAgent):
    ...
    from data_science_tools_agents.agents import DataWranglingAgent
...
def make_data_wrangling_agent(
    ...
    df = pd.DataFrame({"category": ["A", "B", "A", "C"], "value": [10, 20, 15, 5]})
    ...
    prompt_text_human_review = (
        "Are the following data wrangling instructions correct? (Answer 'yes' or provide modifications)\n{steps}"
    )
